...
# LazyJSONEncoder, serialize_to_json, and JSONResponse were all shamelessly
# stolen from http://chronosbox.org/blog/jsonresponse-in-django
...
class JSONResponse(HttpResponse):
    """ JSON response class """
    def __init__(self,content='',json_opts={},mimetype="application/json",status=200,*args,**kwargs):
        """
